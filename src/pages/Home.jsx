...
import { staggerContainer, fadeUpVariant } from '../ui/motion'
  ...
  return (
    <main className="space-y-12 pb-16 overflow-x-hidden bg-steam-cream">
      ...
      <Motion.section
        ...
        className="relative w-full px-4 pt-6 pb-4 sm:px-6 sm:py-7 lg:px-8"
      >
        {/* Video Container */}
        <div className="fade-mask relative flex min-h-[calc(100svh-100px)] w-full flex-col items-center justify-center overflow-hidden rounded-[32px] border-2 border-steam-navy/90 bg-[#111] sm:min-h-[calc(100svh-120px)] sm:rounded-[36px] md:min-h-[calc(100vh-140px)] md:rounded-[44px]">
          ...
          >
            ...
            <Motion.div variants={fadeUpVariant} className="mt-10 flex w-full flex-col items-center gap-4 px-4 sm:w-auto sm:flex-row sm:px-0">
              <Link
                to="/services"
                className="flex h-[52px] w-full items-center justify-center gap-2 rounded-full bg-steam-orange px-8 text-[15px] font-bold uppercase tracking-wide text-white shadow-lg transition-all hover:scale-105 hover:bg-steam-orangeHover active:scale-95 sm:w-auto"
              >
                Our services
                <ArrowRight size={18} />
              </Link>
              <Link
                to="/contact"
                className="flex h-[52px] w-full items-center justify-center gap-2 rounded-full border-2 border-white/30 bg-black/45 px-8 text-[15px] font-bold uppercase tracking-wide text-white backdrop-blur-md transition-all hover:scale-105 hover:bg-black/60 active:scale-95 sm:w-auto"
              >
                Contact us
                <Send size={18} />
              </Link>
